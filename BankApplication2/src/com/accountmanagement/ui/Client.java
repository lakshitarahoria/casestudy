...
//	and contact number- 10 digit number which start from numbers between 6-9
//	enter account holders address- string
//	enter branch name - branch address.String
//	type of account -only 2 kinds allowed, current and savings
//	balance - default 5000 but you can add anything more
//	
//	
